...
function Sideitems() {
  ...
  return (
    <>
    <div className="hidden md:mx-0 md:mb-0 md:border-0 md:bg-white md:w-auto md:h-auto md:flex md:flex-col md:justify-center md:items-stretch md:gap-y-2 md:mt-10 md:px-5 ">
