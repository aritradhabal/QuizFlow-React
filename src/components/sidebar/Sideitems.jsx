...
function Sideitems() {
  ...
  return (
    <>
        <div className="md:w-auto md:flex md:flex-col md:justify-center md:gap-y-2 md:mt-10 md:px-5 flex flex-row justify-evenly items-center h-15 bg-transparent rounded-md">
