...
function Cards() {
  return (
    <>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-2 md:gap-2 lg:gap-3 justify-items-center max-w-full mx-auto max-h-95 overflow-y-auto">
